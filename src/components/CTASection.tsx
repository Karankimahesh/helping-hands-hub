    ...
    <section className="py-24 bg-gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-primary-foreground">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-foreground/20 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
          ...
          >
            Join thousands of generous donors who are making a real difference. 
            Your contribution today could change someone's life tomorrow.
          </motion.p>
